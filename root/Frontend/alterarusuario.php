                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <span class="glyphicon glyphicon glyphicon-user"></span> Alterando Usuários:
                            </div>
                            <div class="panel-body body-panel">
                                ...
                                <?php
                                    ...
                                    print("Alterando os dados do Usuário:</h3><p>");
							    ?>

                                <form action="confirma_alterarusuario.php" method="POST">

                                    <div class="form-row">

                                        <label class="col-form-label">Código:</label>
                                        <input type="text" class="form-control" name="cod_alter"
                                            value="<?php print($Codigo)?>" readonly>

                                        <label class="col-form-label">Nome:</label>
                                        <input type="text" class="form-control" name="nome_alter"
                                            value="<?php print($nome)?>" required>

                                        <label class="col-form-label">Cargo:</label>
                                        <input type="text" class="form-control" name="cargo"
                                            value="<?php print($cargo)?>" required>

                                        <label class="col-form-label">Telefone:</label>
                                        <input maxlength="11" type="text" class="form-control" name="telefone_alter"
                                            value="<?php print($telefone)?>" required>

                                        <label class="col-form-label">Senha:</label>
                                        <input type="text" class="form-control" name="senha_alter"
                                            value="<?php print($senha)?>" required>

                                        <label class="col-form-label">Email:</label>
                                        <input type="text" class="form-control" name="email_alter"
