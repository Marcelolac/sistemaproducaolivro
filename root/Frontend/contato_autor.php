                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <center> 
                                           <nav aria-label="Page navigation">
                                              <ul class="pagination">
                                                <li>
                                                  <a href="contato_autor.php?pagina=1" aria-label="Previous">
                                                ...
                                                for($i=1;$i<=$numero_paginas;$i++){
                                                    ...
                                                    if($pagina==$i)
                                                        $estilo = "class=\"active\"";
                                                    ?>
                                                <li <?php echo $estilo;?> ><a  href="contato_autor.php?pagina=<?php  echo  $i; ?>"><?php echo  $i; ?></a></li>
                                                <?php } ?>
                                                <li>
                                                  <a href="contato_autor.php?pagina=<?php echo $numero_paginas ?>" aria-label="Next">
