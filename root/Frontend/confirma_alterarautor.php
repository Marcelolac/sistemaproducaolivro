                      ...
                      <div class="panel panel-primary">
                        ...
                        <div class="panel-body body-panel">
                          <?php
                            ...
                            print("Alterações do Autor realizada:<p>");
                            print("Código: $cod<br> Nome: <b>$nome_alter</b> <br>Telefone: $telefone_alter <br>Senha: $senha_alter <br>Email: $email_alter<p>");
                            
                            mysqli_query($criar_con, "update usuario set nome_usuario='$nome_alter', telefone='$telefone_alter', senha='$senha_alter', email='$email_alter' where pk_usuario='$cod'") or die ("Não é possível alterar dados da Pessoa!");
