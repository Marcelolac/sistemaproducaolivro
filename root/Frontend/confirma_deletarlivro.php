                      ...
                      <div class="panel panel-primary">
                        ...
                        <div class="panel-body body-panel">
							<?php
								...
								mysqli_query($criar_con, "delete from livro where pk_livro='$cod'") or die ("Não é possível retornar dados do Livro!");

								echo("O Livro | $disciplina | foi deletado com sucesso!");
							?>
